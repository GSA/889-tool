...
class TestDataAdaptors:
    class TestAdaptSamToolToSam:
        ...
        def test_includes_samtools_data():
            parameters = ImmutableMultiDict([('includeSections', 'samToolsData,entityRegistration,coreData'),])
            data_adaptors = DataAdaptors()
            assert data_adaptors.adapt_samtools_to_sam_parameters(parameters) == {
        ...
        def test_includes_samtools_search():
            parameters = ImmutableMultiDict([('samToolsSearch', 'mcmaster carr'),])
            data_adaptors = DataAdaptors()
            assert 'samToolsSearch' not in data_adaptors.adapt_samtools_to_sam_parameters(parameters)
    ...
    class TestAdaptSamResponcesTo889Compliance:
        ...
        def test_no_reps_and_certs(entity):
            data_adaptors = DataAdaptors()
            assert data_adaptors.adapt_sam_response_to_889_compliance(entity)._has_far_response is False
        ...
        def test_is_compliant():
            ...
            data_adaptors = DataAdaptors()
            assert data_adaptors.adapt_sam_response_to_889_compliance(entity).is_compliant is True
        ...
        def test_not_compliant(answers):
            ...
            data_adaptors = DataAdaptors()
            assert data_adaptors.adapt_sam_response_to_889_compliance(entity).is_compliant is False
    ...
    class TestAdaptSamResponcesToExclusions:
        ...
        def test_does_not_have_exclusions(exclusion_status_flag):
            data_adaptors = DataAdaptors()
            entity = {'entityRegistration':{'exclusionStatusFlag': exclusion_status_flag}}
            assert data_adaptors.adapt_sam_response_to_exclusions(entity).has_exclusions is False
        ...
        def test_has_exclusions(exclusion_status_flag):
            data_adaptors = DataAdaptors()
            entity = {'entityRegistration':{'exclusionStatusFlag': exclusion_status_flag}}
            assert data_adaptors.adapt_sam_response_to_exclusions(entity).has_exclusions is True
    ...
    class TestAdaptSamResponcesToRegistrationStatus:
        ...
        def test_registration_is_active():
            ...
            assert data_adaptors.adapt_sam_response_to_registration_status(entity).is_active is True
        ...
        def test_registration_is_not_active(registration_status):
            ...
            assert data_adaptors.adapt_sam_response_to_registration_status(entity).is_active is False
