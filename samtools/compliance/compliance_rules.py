...
class EightEightNine:
    ...
    def set_far(self, provision_id, provision_answer):
        ...
        self._far[provision_id]['text'] = self._far_provision[provision_id].format(answer=answer)
    ...
    def is_compliant(self):
        ...
        if self._has_far_part_c1 and self._has_far_part_c2:
            if self.far['52.204-26.c.1']['answer'] == 'DOES NOT' and \
                    self.far['52.204-26.c.2']['answer'] == 'DOES NOT':
                return True
        return False
